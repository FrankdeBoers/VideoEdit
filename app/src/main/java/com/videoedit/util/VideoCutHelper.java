...
public final class VideoCutHelper {
     ...
     * 视频 时长&尺寸裁剪
     */
    public void cropVideo(final Context context,
                          final String srcVideoPath, final String destPath,
                          final int start, final int duration,
